...
If we define the coning angle as $\Phi$ then the thrust can be found through
integration as:
\begin{equation}
...
\begin{equation}
    Q = \int_0^R T^\prime (r\cos\Phi + precurve\sin\Phi) dr
\end{equation}

% TODO: azimuthally averaging
% TODO: normalization for turbines and props
